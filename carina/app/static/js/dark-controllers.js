...
dark.controller('CardsController', ['$scope','Cards', function($scope, Cards) {
	...
	$scope.cards = [
	                { artist: "Steve Argyle", card: "Admonition Angel", set: "WorldWake",  type: "Creature - Angel", cmc: 6, cost: [{type:"any6", value:1}, {type:"white", value:1}, {type:"blue", value:1}, {type:"green", value:1}, {type:"red", value:1}, {type:"black", value:1}]},
	                ...
	                { artist: "Nils Hamm", card: "Mountain", set: "All Sets",  type: "Basic Land", cmc: 0, cost: [{type:"any12", value:1}, {type:"white-black", value:1}, {type:"tapA", value:1}, {type:"infinity", value:1}, {type:"half", value:1}, {type:"phyrexia-blue", value:1}]}
	  ];
} ]);
