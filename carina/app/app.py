...
class Set(db.Model):
    ...
    def __repr__(self):
        return "[Set: id={}, name={}]".format(self.set_id, self.name)
...
class Card(db.Model):
    ...
    def __repr__(self):
        return "[Card: id={}, name={}, url={}, store_url={}, colors={}, cost={}, cmc={}]".format(self.card_id, self.name, self.url, self.store_url, self.colors, self.cost, self.cmc)

    @property
    def serialize(self):
        return dict(card_id=self.card_id, name=self.name, url=self.url, store_url=self.store_url, colors=self.colors, cost=self.cost, cmc=self.cmc)
